...
hist(CONT.landscape.farm.30m$value[CONT.landscape.farm.30m$metric == "contig_mn"])
...
hist(AI.class.farm.30m$value[ AI.class.farm.30m$class == 7])


AI.landscape.farm.30m <-
    sample_lsm(
        farm.landuse.rast.30m,
        y = farm.boundary.shp,
        level = "landscape",
...
hist(AI.landscape.farm.30m$value)
...
hist(EMS.class.farm.30m$value[ EMS.class.farm.30m$class == 7])


EMS.landscape.farm.30m <-
    sample_lsm(
        farm.landuse.rast.30m,
        y = farm.boundary.shp,
        level = "landscape",
...
hist(EMS.landscape.farm.30m$value)
...
farm.forest <- tibble(
    ...
    CONT.forest = CONT.class.farm.30m$value[CONT.class.farm.30m$metric == "contig_mn" &
                                                CONT.class.farm.30m$class == 7],
    AI.forest = AI.class.farm.30m$value[AI.class.farm.30m$class == 7]
...
farm.landscape <- tibble(
    plot_id = FRACM.landscape.farm.30m$plot_id[FRACM.landscape.farm.30m$metric ==
                                                   "frac_mn"],
    
    FRACM.mean.farm = FRACM.landscape.farm.30m$value[FRACM.landscape.farm.30m$metric ==
                                                         "frac_mn"],
    ...
    AI.farm = AI.landscape.farm.30m$value
...
pairs(all.farm[ -1], lower.panel = panel.smooth, upper.panel = panel.cor)


## ------- Cleanup -------------------------------


remove(FRACM.class.farm.30m, FRACM.landscape.farm.30m,
       AREAM.class.farm.30m, 
       TAREA.class.farm.30m, TAREA.landscape.farm.30m,
       NUMPAT.landscape.farm.30m,
       EDGE.class.farm.30m, EDGE.landscape.farm.30m,
       PD.class.farm.30m, PD.landscape.farm.30m,
       PLAND.class.farm.30m, PLAND.landscape.farm.30m,
       SHDI.landscape.farm.30m,
       CONT.class.farm.30m, CONT.landscape.farm.30m, 
       AI.class.farm.30m, AI.landscape.farm.30m,
       farm.forest, farm.landscape)
