...
We found a total of `r length(unique(c(keyInCocoaOnly, keyInPastureOnly)))` key invertebrate species in our intervention and counterfactual sample (Table 1). A total of `r length(forestKeySpecies)` key species were found in our forest sample.
